...
<title>Processo de recebimento de carga</title>
...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Processo de recebimento de carga", " : "))</script>  : Public  &lt;&lt;BusinessProcess&gt;&gt; BusinessProcess</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">26/10/2017 15:37:38</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">26/10/2017 15:38:24</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{C97629A1-9774-43f4-977A-EFB8BF6EBE5F}</td>
		</tr>
	...
	<div class="TableGroup" id="TableGroup">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow655" onclick="parent.toggleDiv('detailsDIVLinkFlow655', 'DetailsImageLinkFlow655')" />Details:
							<div id="detailsDIVLinkFlow655" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
		...
		<div class="ItemBody" id="FlowFromTable">
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow656" onclick="parent.toggleDiv('detailsDIVLinkFlow656', 'DetailsImageLinkFlow656')" />Details:
							<div id="detailsDIVLinkFlow656" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario657" onclick="parent.toggleDiv('detailsDIVScenario657','DetailsImageScenario657')" />Details:
						<div id="detailsDIVScenario657" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario658" onclick="parent.toggleDiv('detailsDIVScenario658','DetailsImageScenario658')" />Details:
						<div id="detailsDIVScenario658" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario659" onclick="parent.toggleDiv('detailsDIVScenario659','DetailsImageScenario659')" />Details:
						<div id="detailsDIVScenario659" class="DetailsDiv" >
