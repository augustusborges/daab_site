...
<title>Chegada de carga no porto</title>
...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Chegada de carga no porto", " : "))</script>  : Public  &lt;&lt;StartEvent&gt;&gt; StartEvent</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">26/10/2017 15:26:33</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">26/10/2017 15:26:54</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{E22DE62E-84B8-44a2-8206-94EABFE9D19C}</td>
		</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow858" onclick="parent.toggleDiv('detailsDIVLinkFlow858', 'DetailsImageLinkFlow858')" />Details:
							<div id="detailsDIVLinkFlow858" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow859" onclick="parent.toggleDiv('detailsDIVLinkFlow859', 'DetailsImageLinkFlow859')" />Details:
							<div id="detailsDIVLinkFlow859" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario860" onclick="parent.toggleDiv('detailsDIVScenario860','DetailsImageScenario860')" />Details:
						<div id="detailsDIVScenario860" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario861" onclick="parent.toggleDiv('detailsDIVScenario861','DetailsImageScenario861')" />Details:
						<div id="detailsDIVScenario861" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario862" onclick="parent.toggleDiv('detailsDIVScenario862','DetailsImageScenario862')" />Details:
						<div id="detailsDIVScenario862" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario863" onclick="parent.toggleDiv('detailsDIVScenario863','DetailsImageScenario863')" />Details:
						<div id="detailsDIVScenario863" class="DetailsDiv" >
