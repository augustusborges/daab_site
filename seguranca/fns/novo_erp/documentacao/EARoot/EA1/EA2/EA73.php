...
<div class="PageBody">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			...
			<td width="85%" class="ObjectDetailsValue">26/10/2017 10:50:39</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">26/10/2017 10:51:02</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{1B393090-42DA-4864-AEC5-49EFA07F1919}</td>
		</tr>
	...
	<div class="ObjectDetailsNotes">Arquivo é armazenado pela equipe, fora do sistema</div>
		...
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario424" onclick="parent.toggleDiv('detailsDIVScenario424','DetailsImageScenario424')" />Details:
						<div id="detailsDIVScenario424" class="DetailsDiv" >
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td width="30%" class="TableRow" valign="top"><a href="EA100.php">«Activity» Recebimento da PI</a></td>
