...
<div class="PageBody">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			...
			<td width="85%" class="ObjectDetailsValue">26/10/2017 10:52:56</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">26/10/2017 10:53:49</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{1A2EEA69-D1CF-47fc-8FB1-74552A9C9EA2}</td>
		</tr>
	...
	<div class="ObjectDetailsNotes">Conferência realizada de forma manual diretamente na tela do sistema</div>
		...
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario426" onclick="parent.toggleDiv('detailsDIVScenario426','DetailsImageScenario426')" />Details:
						<div id="detailsDIVScenario426" class="DetailsDiv" >
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td width="30%" class="TableRow" valign="top"><a href="EA107.php">«Activity» Conferência PI x PO</a></td>
