...
<div class="PageBody">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			...
			<td width="85%" class="ObjectDetailsValue">26/10/2017 10:44:27</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">26/10/2017 10:45:18</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{E07CC301-CED4-40a9-A4FC-5FCC7D1384D5}</td>
		</tr>
	...
	<div class="ObjectDetailsNotes">O sistema envia alerta ou é necessário a consulta no sistema</div>
		...
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario425" onclick="parent.toggleDiv('detailsDIVScenario425','DetailsImageScenario425')" />Details:
						<div id="detailsDIVScenario425" class="DetailsDiv" >
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td width="30%" class="TableRow" valign="top"><a href="EA108.php">«Activity» Consulta ao Estoque</a></td>
