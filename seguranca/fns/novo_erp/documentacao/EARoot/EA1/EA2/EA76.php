...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Agente", " : "))</script>  : Public  &lt;&lt;Lane&gt;&gt; Lane</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">18/10/2017 15:09:21</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">18/10/2017 15:09:26</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{39049CC7-3122-4601-BA71-2CB14CFE542A}</td>
		</tr>
	...
	<div class="TableGroup" id="TableGroup">
		...
		<div class="ItemBody" id="CustomPropertiesTable">
			...
			<tr>
				<td width="30%" class="TableRow">isDimension:</td>
				<td width="70%" class="TableRow">false</td>
			</tr>

			<tr>
				<td width="30%" class="TableRow">isExternal:</td>
				<td width="70%" class="TableRow">false</td>
			</tr>
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td width="30%" class="TableRow" valign="top"><a href="EA76.php">«Lane» Agente</a></td>
					<td width="15%" class="TableRow" valign="top">ActivityPartition</td>
