...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Valida Impressão", " : "))</script>  : Public  &lt;&lt;EndEvent&gt;&gt; EndEvent</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">03/10/2017 18:27:16</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">03/10/2017 18:49:11</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{D7A428DA-3206-4321-BFE7-CDA0BC680C82}</td>
		</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow265" onclick="parent.toggleDiv('detailsDIVLinkFlow265', 'DetailsImageLinkFlow265')" />Details:
							<div id="detailsDIVLinkFlow265" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
	...
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<td width="50%" class="TableHeading">Value</td>
				...
				<td width="50%" class="TableRow" valign="top">Terminate</td>
			</tr>	
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario266" onclick="parent.toggleDiv('detailsDIVScenario266','DetailsImageScenario266')" />Details:
						<div id="detailsDIVScenario266" class="DetailsDiv" >
						<div class="ObjectDetailsNotes">Values: None,Cancel,Compensation,Error,Escalation,Message,Multiple,Terminate,Signal<br />Default: None<br /></div>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario267" onclick="parent.toggleDiv('detailsDIVScenario267','DetailsImageScenario267')" />Details:
						<div id="detailsDIVScenario267" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario268" onclick="parent.toggleDiv('detailsDIVScenario268','DetailsImageScenario268')" />Details:
						<div id="detailsDIVScenario268" class="DetailsDiv" >
			...
			<tr>
				...
				<td width="70%" class="TableRow">BPMN2.0::EndEvent::eventDefinition</td>
			</tr>

			<tr>
				<td width="30%" class="TableRow">_tagGroups:</td>
				<td width="70%" class="TableRow">Base Element,End Event,Compensation Event,Error Event,Escalation Event,Message Event,Signal Event,Other</td>
			</tr>

			<tr>
				<td width="30%" class="TableRow">_tagGroupStates:</td>
				<td width="70%" class="TableRow">Base Element=closed;End Event=open;Compensation Event=open;Error Event=open;Escalation Event=open;Message Event=open;Signal Event=open;Other=closed;</td>
			</tr>

			<tr>
				<td width="30%" class="TableRow">_tagGroupings:</td>
				<td width="70%" class="TableRow">auditing=Base Element;categoryValue=Base Element;documentation=Base Element;monitoring=Base Element;eventDefinition=End Event;eventDefinitionRefs=End Event;inputSet=End Event;activityRef=Compensation Event;waitForCompletion=Compensation Event;errorRef=Error Event;escalationRef=Escalation Event;messageRef=Message Event;operationRef=Message Event;signalRef=Signal Event;assignments=Other;implementation=Other;
</td>
			</tr>
