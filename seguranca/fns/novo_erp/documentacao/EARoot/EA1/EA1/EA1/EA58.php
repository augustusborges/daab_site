...
<title>Processo Impressão</title>
...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Processo Impressão", " : "))</script>  : Public  &lt;&lt;BusinessProcess&gt;&gt; BusinessProcess</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:28:25</td>
		</tr>
		<tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{16560925-42B9-46ed-AE81-A2E5B5A63753}</td>
		</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow356" onclick="parent.toggleDiv('detailsDIVLinkFlow356', 'DetailsImageLinkFlow356')" />Details:
							<div id="detailsDIVLinkFlow356" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario357" onclick="parent.toggleDiv('detailsDIVScenario357','DetailsImageScenario357')" />Details:
						<div id="detailsDIVScenario357" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario358" onclick="parent.toggleDiv('detailsDIVScenario358','DetailsImageScenario358')" />Details:
						<div id="detailsDIVScenario358" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario359" onclick="parent.toggleDiv('detailsDIVScenario359','DetailsImageScenario359')" />Details:
						<div id="detailsDIVScenario359" class="DetailsDiv" >
