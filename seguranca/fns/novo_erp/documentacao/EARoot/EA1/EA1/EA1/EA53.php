...
<img src="EA54.png" border="0" />

	<div class="ObjectTitle">Transferencia de produtos entre estoque : Business Process diagram</div>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		...
		<tr>
			...
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:23:42</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td width="85%" class="ObjectDetailsValue">{B7C9512A-CBBB-425b-A7CF-8FD90A8D7870}</td>
		</tr>
	</table>
