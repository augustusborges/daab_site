...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Processo Selagem", " : "))</script>  : Public  &lt;&lt;BusinessProcess&gt;&gt; BusinessProcess</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:28:43</td>
		</tr>
		<tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{A17DE505-9A66-4049-AE3D-A10A26C78FD0}</td>
		</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow364" onclick="parent.toggleDiv('detailsDIVLinkFlow364', 'DetailsImageLinkFlow364')" />Details:
							<div id="detailsDIVLinkFlow364" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario365" onclick="parent.toggleDiv('detailsDIVScenario365','DetailsImageScenario365')" />Details:
						<div id="detailsDIVScenario365" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario366" onclick="parent.toggleDiv('detailsDIVScenario366','DetailsImageScenario366')" />Details:
						<div id="detailsDIVScenario366" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario367" onclick="parent.toggleDiv('detailsDIVScenario367','DetailsImageScenario367')" />Details:
						<div id="detailsDIVScenario367" class="DetailsDiv" >
