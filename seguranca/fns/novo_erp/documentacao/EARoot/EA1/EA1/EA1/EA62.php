...
<title>Transferencia de produto entre filiais</title>
...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Transferencia de produto entre filiais", " : "))</script>  : Public  &lt;&lt;BusinessProcess&gt;&gt; BusinessProcess</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:21:30</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">04/10/2017 09:21:52</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{15BE35B3-66EB-4f24-959E-BDBD5FF25D2A}</td>
		</tr>
	...
	<div class="TableGroup" id="TableGroup">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow377" onclick="parent.toggleDiv('detailsDIVLinkFlow377', 'DetailsImageLinkFlow377')" />Details:
							<div id="detailsDIVLinkFlow377" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
		...
		<div class="ItemBody" id="FlowFromTable">
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow378" onclick="parent.toggleDiv('detailsDIVLinkFlow378', 'DetailsImageLinkFlow378')" />Details:
							<div id="detailsDIVLinkFlow378" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario379" onclick="parent.toggleDiv('detailsDIVScenario379','DetailsImageScenario379')" />Details:
						<div id="detailsDIVScenario379" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario380" onclick="parent.toggleDiv('detailsDIVScenario380','DetailsImageScenario380')" />Details:
						<div id="detailsDIVScenario380" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario381" onclick="parent.toggleDiv('detailsDIVScenario381','DetailsImageScenario381')" />Details:
						<div id="detailsDIVScenario381" class="DetailsDiv" >
