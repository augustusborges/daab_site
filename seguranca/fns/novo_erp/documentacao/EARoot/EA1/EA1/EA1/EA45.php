...
<img src="EA46.png" border="0" />

	<div class="ObjectTitle">Processo Impressão : Business Process diagram</div>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:28:26</td>
		</tr>
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Modified:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:28:36</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td width="85%" class="ObjectDetailsValue">{9E5C2B17-FDAA-4ca5-903D-105DA7DC898B}</td>
		</tr>
	</table>
