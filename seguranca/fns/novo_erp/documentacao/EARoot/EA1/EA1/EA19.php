...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Faturamento", " : "))</script>  : Public  &lt;&lt;EndEvent&gt;&gt; EndEvent</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">03/10/2017 15:50:44</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">03/10/2017 16:53:49</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{52CCD228-4DC7-4ed5-9AD0-F8B834EBE14C}</td>
		</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow59" onclick="parent.toggleDiv('detailsDIVLinkFlow59', 'DetailsImageLinkFlow59')" />Details:
							<div id="detailsDIVLinkFlow59" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow60" onclick="parent.toggleDiv('detailsDIVLinkFlow60', 'DetailsImageLinkFlow60')" />Details:
							<div id="detailsDIVLinkFlow60" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario61" onclick="parent.toggleDiv('detailsDIVScenario61','DetailsImageScenario61')" />Details:
						<div id="detailsDIVScenario61" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario62" onclick="parent.toggleDiv('detailsDIVScenario62','DetailsImageScenario62')" />Details:
						<div id="detailsDIVScenario62" class="DetailsDiv" >
