...
<div class="PageBody">
	...
	<span class="ObjectTitle"><script type="text/javascript">document.write(nameClassifier("Pedido Aprovado", " : "))</script>  : Public  &lt;&lt;IntermediateEvent&gt;&gt; IntermediateEvent</span>
	<table border="0" cellpadding="0" cellspacing="0" class="ObjectDetails">
		<tr>
			<td width="15%" class="ObjectDetailsTopic">Created:</td>
			<td width="85%" class="ObjectDetailsValue">04/10/2017 09:08:03</td>
		</tr>
		<tr>
			<td class="ObjectDetailsTopic">Modified:</td>
			<td class="ObjectDetailsValue">04/10/2017 09:08:25</td>
		</tr>
		...
		<tr id="adv00" style="display: none;">
			...
			<td class="ObjectDetailsValue">{BE6EEEA9-26FA-4a5f-8CAC-45BB7D6749CC}</td>
		</tr>
	...
	<div class="TableGroup" id="TableGroup">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow74" onclick="parent.toggleDiv('detailsDIVLinkFlow74', 'DetailsImageLinkFlow74')" />Details:
							<div id="detailsDIVLinkFlow74" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
		...
		<div class="ItemBody" id="FlowFromTable">
			<table border="0" cellspacing="0" cellpadding="0" class="Table">
				...
				<tr>
					<td class="TableRowBottomDashed"  colspan="2">
						<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageLinkFlow75" onclick="parent.toggleDiv('detailsDIVLinkFlow75', 'DetailsImageLinkFlow75')" />Details:
							<div id="detailsDIVLinkFlow75" class="DetailsDiv" >
							&nbsp;
							</div>
						</div>
					</td>
...
<div class="ItemBody" id="TaggedValTable">
	<table align="center" border="0" cellspacing="0" cellpadding="0" class="Table">
		<tr>
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario76" onclick="parent.toggleDiv('detailsDIVScenario76','DetailsImageScenario76')" />Details:
						<div id="detailsDIVScenario76" class="DetailsDiv" >
			...
			<tr>
				<td class="TableRowBottomDashed"  colspan="2">
					<div class="DetailsDivParent"><img src="../../../images/minus03.gif" align="absmiddle" id="DetailsImageScenario77" onclick="parent.toggleDiv('detailsDIVScenario77','DetailsImageScenario77')" />Details:
						<div id="detailsDIVScenario77" class="DetailsDiv" >
