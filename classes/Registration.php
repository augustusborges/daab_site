...
class Registration
{
    ...
    private function registerNewUser(){
        //Validações de dados de cadastramento
        if (empty($_POST['user_company'])) {
            $this->errors[] = "Favor informar a empresa";
        ...
        elseif (!empty($_POST['user_name'])
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $user_company = $this->db_connection->real_escape_string(strip_tags($_POST['user_company'], ENT_QUOTES));
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $sql = "INSERT INTO cliente (nome, email, senha)
                            VALUES('" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','" .$user_company."');";
                    
                    $queryNewUserInsert = $this->db_connection->query($sql);
